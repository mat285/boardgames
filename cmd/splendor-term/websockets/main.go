...
import (
	...
	http "github.com/mat285/boardgames/pkg/server/http/v1alpha1"
	websockets "github.com/mat285/boardgames/pkg/server/websockets/v1alpha1"
)
...
func getPlayers(g v1alpha1.Game, s *http.Server) []connection.Client {
...
func getLocalClient(id uuid.UUID, s *http.Server) *websockets.Client {
	return local.NewClient(id, s)
}

func getServer() *http.Server {
	return http.New(uuid.V4(), web.Config{})
}
